...
class ViewBalanceViewModel {
	...
	func configureModel() {
		...
		let firstExpense = ExpenseModel(payer: balanceModel.payer, amount: perShare * Double(balanceModel.participants.count))
		...
		for parti in balanceModel.participants {
			...
			var newPartiAmount: Double = firstExpense.amount
			...
			expenseArray.append(partiExpense)
		}
	}
